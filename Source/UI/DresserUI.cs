    ...
    internal class DresserUI : Window
    {
        ...
        public override void DoWindowContents(Rect inRect)
        {
            try
            {
                ...
                Widgets.Label(new Rect(0f, 0f, this.InitialSize.y / 2f + 45f, 50f),
                    "ChangeDresser.DresserLabel".Translate());
                ...
                WidgetUtil.AddSelectorWidget(portraitRect.xMax + 30, 10f, editorWidth, null,
                    this.dresserDto.EditorTypeSelectionDto);
                ...
                switch ((CurrentEditorEnum)this.dresserDto.EditorTypeSelectionDto.SelectedItem)
                {
                    case CurrentEditorEnum.ChangeDresserApparelColor:
                        WidgetUtil.AddAppararelColorSelectionWidget(editorLeft, editorTop, editorWidth,
                            this.dresserDto.ApparelSelectionsContainer, this.GetClearColorCallback());
                        break;
                    case CurrentEditorEnum.ChangeDresserApparelLayerColor:
                        WidgetUtil.AddAppararelColorByLayerSelectionWidget(editorLeft, editorTop, editorWidth,
                            this.dresserDto.ApparelLayerSelectionsContainer, this.GetClearColorCallback());
                        break;
                    case CurrentEditorEnum.ChangeDresserBody:
                        bool isShowing = false;
                        float top = editorTop;
                        if (this.dresserDto.BodyTypeSelectionDto != null &&
                            this.dresserDto.BodyTypeSelectionDto.Count > 1)
                        {
                            WidgetUtil.AddSelectorWidget(editorLeft, top, editorWidth,
                                "ChangeDresser.BodyType".Translate() + ":", this.dresserDto.BodyTypeSelectionDto);
                            top += WidgetUtil.SelectionRowHeight + 20f;
                            isShowing = true;
                        }

                        if (this.dresserDto.HeadTypeSelectionDto != null &&
                            this.dresserDto.HeadTypeSelectionDto.Count > 1)
                        {
                            WidgetUtil.AddSelectorWidget(editorLeft, top, editorWidth,
                                "ChangeDresser.HeadType".Translate() + ":", this.dresserDto.HeadTypeSelectionDto);
                            top += WidgetUtil.SelectionRowHeight + 20f;
                            isShowing = true;
                        }

                        if (this.dresserDto.SkinColorDto != null)
                        {
                            WidgetUtil.AddColorSelectorWidget(editorLeft, top, editorWidth,
                                this.dresserDto.SkinColorDto,
                                this.dresserDto.SkinColorDto.ColorPresetsDTO);
                            top += WidgetUtil.SelectionRowHeight + 120f;
                            isShowing = true;
                        }

                        if (this.dresserDto.SkinColorSliderDto != null)
                        {
                            WidgetUtil.AddSliderWidget(editorLeft, top, editorWidth,
                                "ChangeDresser.SkinColor".Translate() + ":", this.dresserDto.SkinColorSliderDto);
                            isShowing = true;
                        }

                        if (!isShowing)
                        {
                            GUI.Label(new Rect(editorLeft, top, editorWidth, 40),
                                "ChangeDresser.NoEditableAttributes".Translate());
                        }

                        if (Settings.ShowGenderAgeChange)
                        {
                            GUI.Label(new Rect(editorLeft, 360f, editorWidth, 40f),
                                "ChangeDresser.GenderChangeWarning".Translate(), WidgetUtil.MiddleCenter);
                            top = 400f;
                            WidgetUtil.AddSelectorWidget(editorLeft, top, editorWidth,
                                "ChangeDresser.Gender".Translate() + ":", this.dresserDto.GenderSelectionDto);

                            top += WidgetUtil.SelectionRowHeight + 5;
                            long ageBio = this.dresserDto.Pawn.ageTracker.AgeBiologicalTicks;
                            if (AddLongInput(editorLeft, top, 120, 80, "ChangeDresser.AgeBiological".Translate() + ":",
                                    ref ageBio, MAX_AGE, TICKS_PER_YEAR))
                            {
                            ...
                            if (AddLongInput(editorLeft, top, 120, 80,
                                    "ChangeDresser.AgeChronological".Translate() + ":", ref ageChron, MAX_AGE,
                                    TICKS_PER_YEAR))
                            {
                    ...
                    case CurrentEditorEnum.ChangeDresserHair:
                        ...
                        if (this.dresserDto.HairStyleSelectionDto != null)
                        {
                            ...
                            if (showHairColor)
                            {
                            WidgetUtil.AddColorSelectorWidget(editorLeft, editorTop + listboxHeight + 10f, editorWidth,
                                this.dresserDto.HairColorSelectionDto,
                                this.dresserDto.HairColorSelectionDto.ColorPresetsDTO);
                            }

                            if (this.dresserDto.GradientHairColorSelectionDto != null)
                            {
                                Text.Font = GameFont.Tiny;
                                Widgets.CheckboxLabeled(new Rect(15f, y + 5f, 120f, 24f),
                                    "GradientHairTitle".Translate(),
                                    ref this.dresserDto.GradientHairColorSelectionDto.IsGradientEnabled);
                                if (this.dresserDto.GradientHairColorSelectionDto.IsGradientEnabled)
                                {
                                    WidgetUtil.AddColorSelectorWidget(15f, editorTop + listboxHeight + 10f, editorWidth,
                                        this.dresserDto.GradientHairColorSelectionDto,
                                        this.dresserDto.HairColorSelectionDto.ColorPresetsDTO);
                                }
                            }
                        }
                    ...
                    case CurrentEditorEnum.ChangeDresserAlienSkinColor:
                        if (this.dresserDto.AlienSkinColorPrimary != null)
                        {
                            ...
                            Text.Font = GameFont.Medium;
                            GUI.Label(new Rect(editorLeft, editorTop, editorWidth, 30),
                                "ChangeDresser.AlienPrimarySkinColor".Translate());
                            Text.Font = GameFont.Small;

                            WidgetUtil.AddColorSelectorWidget(editorLeft, editorTop + 40, editorWidth,
                                this.dresserDto.AlienSkinColorPrimary, null);
                        }
                        ...
                        if (this.dresserDto.AlienSkinColorSecondary != null)
                        {
                            GUI.color = Color.white;
                            Text.Font = GameFont.Medium;
                            GUI.Label(new Rect(editorLeft, editorTop + 260, editorWidth, 30),
                                "ChangeDresser.AlienSecondarySkinColor".Translate());
                            Text.Font = GameFont.Small;

                            WidgetUtil.AddColorSelectorWidget(editorLeft, editorTop + 300, editorWidth,
                                this.dresserDto.AlienSkinColorSecondary, null);
                        }
                    ...
                    case CurrentEditorEnum.ChangeDresserAlienHairColor:
                        if (this.dresserDto.AlienHairColorPrimary != null)
                        {
                            ...
                            Text.Font = GameFont.Medium;
                            GUI.Label(new Rect(editorLeft, editorTop, editorWidth, 30),
                                "ChangeDresser.AlienPrimaryHairColor".Translate());
                            Text.Font = GameFont.Small;
                    
                            WidgetUtil.AddColorSelectorWidget(editorLeft, editorTop + 40, editorWidth,
                                this.dresserDto.AlienHairColorPrimary, null);
                        }
                        ...
                        if (this.dresserDto.AlienHairColorSecondary != null)
                        {
                            ...
                            Text.Font = GameFont.Medium;
                            GUI.Label(new Rect(editorLeft, editorTop + 260, editorWidth, 30),
                                "ChangeDresser.AlienSecondaryHairColor".Translate());
                            Text.Font = GameFont.Small;
                    
                            WidgetUtil.AddColorSelectorWidget(editorLeft, editorTop + 300, editorWidth,
                                this.dresserDto.AlienHairColorSecondary, null);
                        }
                ...
                Rect bottomButtonsRect = new Rect(editorLeft, this.InitialSize.y - WidgetUtil.SelectionRowHeight - 36,
                    xWidth, WidgetUtil.SelectionRowHeight);
            ...
            catch (Exception e)
            {
                ...
                Messages.Message(this.GetType().Name + " closed due to: " + e.GetType().Name + " " + e.Message,
        ...
        private bool AddLongInput(float labelLeft, float top, float inputLeft, float inputWidth, string label,
            ref long value, long maxValue, long factor = 1)
        {
            string stringValue;
            if (value == -1)
            {
        ...
        public override void PreClose()
        {
            ...
            try
            {
                ...
                {
                    if (this.dresserDto.SkinColorDto != null &&
                        this.dresserDto.SkinColorDto.ColorPresetsDTO != null &&
                        this.dresserDto.SkinColorDto.ColorPresetsDTO.IsModified == true)
                    {
                        IOUtil.SaveColorPresets(ColorPresetType.Skin,
                            this.dresserDto.SkinColorDto.ColorPresetsDTO);
                    }
                    ...
                    {
                        IOUtil.SaveColorPresets(ColorPresetType.Apparel,
                            this.dresserDto.ApparelSelectionsContainer.ColorPresetsDTO);
                    }
                    ...
                    {
                        IOUtil.SaveColorPresets(ColorPresetType.Hair,
                            this.dresserDto.HairColorSelectionDto.ColorPresetsDTO);
                    }
                }
            ...
            {
                Log.Error("Error on DresserUI.PreClose: " + e.GetType().Name + " " + e.Message + Environment.NewLine +
                          e.StackTrace);
            }
#if TRACE
        ...
        private void UpdatePawn(object sender, object value)
        {
            if (sender != null)
            {
                ...
                else if (sender is HairColorSelectionDTO)
                {
                    ...
                    {
                        pawn.story.HairColor = (Color)value; // todo: Color
                    }
                }
                ...
                {
                    // dresserDto.SetCrownType(value); // todo:crown
                    pawn.story.headType = (HeadTypeDef)value;
                }
                else if (sender is SliderWidgetDTO)
                {
                    // pawn.story.melanin = (float)value; //todo: melanin
                }
                else if (sender is SelectionColorWidgetDTO)
                {
                    pawn.story.SkinColorBase = (Color)value;
                }
            }
